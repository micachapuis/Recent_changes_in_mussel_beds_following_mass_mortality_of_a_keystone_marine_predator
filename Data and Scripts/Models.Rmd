...
```{r}
mussel_cover_yearly_avg <- read.csv("Data/Data for Models/mussel_cover_yearly_avg.csv")
mussel_height_yearly_avg <- read.csv("Data/Data for Models/mussel_height_yearly_avg.csv")

mussels <- read.csv("Data/Data for Models/mussels.csv")
mussels_B <- read.csv("Data/Data for Models/mussels_B.csv")

seastars_avg <- read.csv("Data/Data for Models/seastars_avg.csv")
whelks_avg <- read.csv("Data/Data for Models/whelks_avg.csv")

daily_wavedata <- read.csv("Data/daily_wavedata.csv")
```
...
Written with ChatGPT: Function to calculate average of any variable (here WVHT and WTMP) for a given interval (here we want to take the date of mussel data collection and calculate the average of the variable for the 3 months before that day)
...
for (i in 1:nrow(mussels)) {
  ...
  average_waveheight <- calculate_average_variable(end_date, daily_wavedata, "Wave.Height")
...
for (i in 1:nrow(mussels)) {
  ...
  average_watertemp <- calculate_average_variable(end_date, daily_wavedata, "Water.Temp")
  # Store result in mussels
...
```{r}
#write.csv(mussels.abiotic, file = "mussels.abiotic.csv", row.names = FALSE)  #to use in NOAA_Wave_Data script
```
