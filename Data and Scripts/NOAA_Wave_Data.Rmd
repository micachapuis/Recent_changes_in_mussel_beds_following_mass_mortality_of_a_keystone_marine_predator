...
Wave Data needs to be put together with mussel data because it needs to be averaged based on each date of mussel data collection, so Figure 2 (model data) panels are created in a different script.